...
Helpful controls are shown in the footer. The interface supports keyboard-driven navigation, including vim-style `h/j/k/l` movement. The booking form includes a discreet startup toggle in the lower-right corner with the `a` shortcut hint.
